...
@Component({
  ...
  templateUrl: './users-expenses.component.html',
  styleUrl: './users-expenses.component.css',
})
export class UsersExpensesComponent {
  ...
  constructor(public telegramService: TelegramService) {
    // const userDataGet = this.telegramService.getUserData;
