...
export type GetProductByIdAdminQuery = {
  __typename?: 'Query';
  getProductByIdAdmin: {
 ...
 * });
 */
export function useGetProductByIdAdminQuery(
  ...
  return Apollo.useQuery<
    GetProductByIdAdminQuery,
    GetProductByIdAdminQueryVariables
  >(GetProductByIdAdminDocument, options);
}
export function useGetProductByIdAdminLazyQuery(
...
export type GetProductByIdAdminQueryHookResult = ReturnType<
  typeof useGetProductByIdAdminQuery
>;
export type GetProductByIdAdminLazyQueryHookResult = ReturnType<
  typeof useGetProductByIdAdminLazyQuery
>;
export type GetProductByIdAdminQueryResult = Apollo.QueryResult<
  GetProductByIdAdminQuery,
  GetProductByIdAdminQueryVariables
>;
