 ...
 */
@Injectable()
export class GglAuthCustomerGuard extends AuthGuard('local-customer') {
  constructor() {
    super();
  }
  /**
  ...
  override getRequest(context: ExecutionContext) {
    ...
    request.body = ctx.getArgs().loginCustomerInput; // Установка тела запроса из аргументов GraphQL.
